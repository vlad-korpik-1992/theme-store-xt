...
function xt_setup() {
	/*
		...
		* If you're building a theme based on xt, use a find and replace
		* to change 'xt' to the name of your theme in all the template files.
		*/
...
add_action( 'after_setup_theme', 'xt_setup' );
 ...
 */
function xt_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'xt_content_width', 640 );
}
add_action( 'after_setup_theme', 'xt_content_width', 0 );
...
function xt_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'xt' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'xt' ),
...
function xt_scripts() {
	wp_enqueue_style('xt-style', get_stylesheet_uri(), array(), _S_VERSION);

	wp_deregister_script('jquery');

	wp_register_script('jquery', get_template_directory_uri() . '/assets/js/jquery-3.7.1.min.js', array(), null, true);
	...
	if ( is_page_template('page-video.php')) {
		...
		wp_register_script('main-page-video-script', get_template_directory_uri() . '/assets/js/main-page-video.js', array(), null, true);
	...
	if ( is_page_template('page-home.php')) {
		...
		wp_register_script('main-slider-script', get_template_directory_uri() . '/assets/js/main-slider.js', array(), null, true);
