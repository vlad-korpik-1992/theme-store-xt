        ...
        <div class="header__right">
            ...
            <div class="social">
                <div class="social__items">
                    <a class="social__items__link" href="<?php echo the_field('social_instagram', 197)?>" target="_blank" rel="nofollow">
                ...
                <div class="social__items">
                    <a class="social__items__link" href="<?php echo the_field('social_facebook', 197)?>" target="_blank" rel="nofollow">
                        <svg class="social__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none">
                ...
                <div class="social__items">
                    <a class="social__items__link" href="<?php echo the_field('social_telegram', 197)?>" target="_blank" rel="nofollow">
                        <svg class="social__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none">
                ...
                <div class="social__items">
                    <a class="social__items__link" href="<?php echo the_field('social_twitter', 197)?>" target="_blank" rel="nofollow">
                        <svg class="social__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none">
                ...
                <div class="social__items">
                    <a class="social__items__link" href="<?php echo the_field('social_tiktok', 197)?>" target="_blank" rel="nofollow">
                        <svg class="social__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none">
                ...
                <div class="social__items">
                    <a class="social__items__link" href="<?php echo the_field('social_youtube', 197)?>" target="_blank" rel="nofollow">
                        <svg class="social__icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none">
